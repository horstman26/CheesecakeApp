...
var host = "35.185.195.145";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "cheesecakePerson";         //username (change to match your db)
var password = "3ducks!";  //password (change to match your db, yes this is very poor practice)
